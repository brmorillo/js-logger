...
describe('PinoLogger', () => {
   ...
   describe('info()', () => {
      ...
      it('should log info message with multiple metadata', () => {
         ...
         expect(infoSpy).toHaveBeenCalledWith({ meta: ['str', 123, { key: 'val' }] }, 'Multiple');
      });
      ...
      it('should handle undefined metadata', () => {
         ...
         expect(infoSpy).toHaveBeenCalledWith({ meta: [undefined] }, 'Undefined value');
      });
   ...
   describe('warn()', () => {
      ...
      it('should log warn with multiple params', () => {
         ...
         expect(warnSpy).toHaveBeenCalledWith({ meta: ['param1', { key: 'value' }] }, 'Multiple warns');
      });
   });
   ...
   describe('error()', () => {
      ...
      it('should log error with stack trace', () => {
         ...
         expect(errorSpy).toHaveBeenCalledWith({ meta: [error.stack] }, 'Stack test');
      });
      ...
      it('should log error with custom error object', () => {
         ...
         expect(errorSpy).toHaveBeenCalledWith({ meta: [customError] }, 'Custom error occurred');
      });
   });
   ...
   describe('debug()', () => {
      ...
      it('should log debug with detailed metadata', () => {
         ...
         expect(debugSpy).toHaveBeenCalledWith({ meta: [debug] }, 'Query executed');
      });
      ...
      it('should log debug with performance data', () => {
         ...
         expect(debugSpy).toHaveBeenCalledWith({ meta: [perf] }, 'Performance metrics');
      });
   });
   ...
   describe('Complex Data Types', () => {
      ...
      it('should handle very large arrays', () => {
         ...
         expect(infoSpy).toHaveBeenCalledWith({ meta: [largeArray] }, 'Large array');
      });
      ...
      it('should handle mixed types in array', () => {
         const mixed = [1, 'string', true, null, undefined, { obj: 'value' }, [1, 2]];
   ...
   describe('Edge Cases', () => {
      ...
      it('should handle class instance', () => {
         ...
         expect(infoSpy).toHaveBeenCalledWith({ meta: [instance] }, 'Class instance');
      });
   });
   ...
   describe('Performance', () => {
      ...
      it('should handle large metadata objects efficiently', () => {
         ...
         expect(infoSpy).toHaveBeenCalledWith({ meta: [largeObj] }, 'Large metadata');
